...
class Attention(nn.Module):
    def __init__(self,ps):
        ...
        self.D = 128
        self.K = 1
        self.P = 48*(((ps-4)/2-2)/2)*(((ps-4)/2-2)/2) # this is the size of the last three dimensions of the output of the feature extraction step

        self.feature_extractor_part1 = nn.Sequential(
            nn.Conv2d(3, 36, kernel_size=4, stride=1),
            nn.ReLU(),
