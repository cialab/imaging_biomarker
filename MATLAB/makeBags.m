...
% Configuration
load('/isilon/datalake/cialab/scratch/cialab/tet/MATLAB/mil/multi_labels.mat');
slidedir='/isilon/datalake/cialab/original/cialab/image_database/d00127/Scans';
fg=0.5;
wd='/isilon/datalake/cialab/scratch/cialab/tet/MATLAB/mil/multi_datasets';
patch_sizes=[28,32];
meanstds=[10,50,100,500,1000,5000,8000,10000;
          2,10,20,100,200,1000,1600,2000];
